...
CLASS_MARKERS = {
    'депрессия': [
        'депресси', 'депрессив', 'антидепрессант',
        ...
        'не хочу жить', 'смысл жизни', 'нет желания', 'прокрастинац',
        'выгорани', 'ангедони',
    ],
    'тревожное р-во': [
        'паническ', 'паник', 'тревог', 'тревожн',
        'страх', 'боюсь', 'боится',
        'сердце бьёт', 'сердце бьет', 'сердцебиени',
        'не хватает воздуха', 'задыхаюсь', 'удушь',
        'фоби', 'навязчив', 'избегани',
        'генерализованн', 'агорафоби', 'социофоби', 'социальн тревог',
        'вегетатив', 'дереализаци', 'деперсонализаци',
    ],
    'ОКР': [
        'ритуал', 'перепроверк', 'навязчив',
        'компульси', 'обсесси', 'оkр', 'окр',
        'проверяю', 'мою руки', 'страх заражени',
        'страх причинить', 'магическ мышлени',
        'повторяю', 'считаю', 'симметри',
        'навязчивые мысли', 'нежелательн мысл',
    ],
    'ПРЛ': [
        'пустот', 'идеализаци', 'обесценивани',
        'пограничн', 'прл', 'бпр',
        'страх быть брошен', 'страх одиночеств',
        'эмоциональн качел', 'импульсивн',
        'самоповреждени', 'порезы', 'членовредительств',
        'нестабильн', 'диссоциаци', 'расщеплени',
        'бурн отношени', 'токсичн отношени',
    ],
    'БАР': [
        'биполяр', 'бар ', ' бар', 'мани', 'гипомани',
        'литий', 'нормотимик',
        'депакин', 'ламиктал', 'ламотриджин',
        'сероквел', 'кветиапин', 'карбамазепин', 'вальпроат',
        'смена настроени', 'перепады настроени',
        'эйфори', 'грандиозн', 'не сплю', 'бессонниц',
        'маниакальн', 'депрессивн эпизод',
    ],
    'шизофрени': [
        'шизофрен', 'шизоаффектив',
        'галлюцинаци', 'галлюцинир',
        'бред', 'бредов', 'голоса', 'голос в голов',
        'психоз', 'психотич',
        'антипсихотик', 'нейролептик',
        'галоперидол', 'клозапин', 'оланзапин', 'рисперидон', 'арипипразол',
        'негативн симптом', 'позитивн симптом',
        'расщеплени личност', 'параноидн',
    ],
}
...
df_initial = df_initial_quality.reset_index(drop=True)

print(f"\nClass distribution after quality filter:")
print(df_initial['tag'].value_counts().to_string())
